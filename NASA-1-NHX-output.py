...
result1 = pd.read_table('/home/jeet/Desktop/1860_1993_2050_NITROGEN_830/data-from-NASA/NHx-deposition1860.txt', sep='\s+')
...
result11 = result1['NHx-deposition']
result12 = result1['mg']
...
plt.title('-------[ NHx-deposition - 1860 ]--------')
plt.xlabel('fequency of values -->')
plt.ylabel('data range -->')

plt.scatter(result11,np.arange(346),label="Max value for total data = 876.7999")
plt.scatter(result12,np.arange(346),label="Min value for total data = -66.7699")
...
result2 = pd.read_table('/home/jeet/Desktop/1860_1993_2050_NITROGEN_830/data-from-NASA/NHx-deposition1993.txt', sep='\s+')

result21 = result2['NHx-deposition']
result22 = result2['mg']
...
plt.title('-------[ NHx-deposition - 1993 ]--------')
plt.xlabel('fequency of values -->')
plt.ylabel('data range -->')

plt.scatter(result21,np.arange(346),label="Max value for total data = 2680.0")
plt.scatter(result22,np.arange(346),label="Min value for total data = -23.27")
...
result3 = pd.read_table('/home/jeet/Desktop/1860_1993_2050_NITROGEN_830/data-from-NASA/NHx-deposition2050.txt', sep='\s+')

result31 = result3['NHx-deposition']
result32 = result3['mg']
...
plt.title('-------[ NHx-deposition - 2050 ]--------')
plt.xlabel('fequency of values -->')
plt.ylabel('data range -->')

plt.scatter(result31,np.arange(346),label="Max value for total data = 7120.57999")
plt.scatter(result32,np.arange(346),label="Min value for total data = -23.68")
