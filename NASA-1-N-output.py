...
result1 = pd.read_table('/home/jeet/Desktop/1860_1993_2050_NITROGEN_830/data-from-NASA/N-deposition1860.txt', sep='\s+')

result11 = result1['N-deposition']
result12 = result1['mg']
...
plt.title('-------[ N-deposition - 1860 ]--------')
plt.xlabel('fequency of values -->')
plt.ylabel('data range -->')

plt.scatter(result11,np.arange(346),label="Max value for total data = 995.08004")
plt.scatter(result12,np.arange(346),label="Min value for total data = -45.99999")
...
# data set for ------ N-deposition1993.txt ------------------

result2 = pd.read_table('/home/jeet/Desktop/1860_1993_2050_NITROGEN_830/data-from-NASA/N-deposition1993.txt', sep='\s+')

result21 = result2['N-deposition']
result22 = result2['mg']
...
plt.title('-------[ N-deposition - 1993 ]--------')
plt.xlabel('fequency of values -->')
plt.ylabel('data range -->')

plt.scatter(result21,np.arange(346),label="Max value for total data = 3590.55999")
plt.scatter(result22,np.arange(346),label="Min value for total data = -14.27999")
...
#----------- data analysis for N-deposition2050.txt ---------------

result3 = pd.read_table('/home/jeet/Desktop/1860_1993_2050_NITROGEN_830/data-from-NASA/N-deposition2050.txt', sep='\s+')

result31 = result3['N-deposition']
result32 = result3['mg']
...
plt.title('-------[ N-deposition - 2050 ]--------')
plt.xlabel('fequency of values -->')
plt.ylabel('data range -->')

plt.scatter(result31,np.arange(346),label="Max value for total data = 8297.98999")
plt.scatter(result32,np.arange(346),label="Min value for total data = -11.3900")
